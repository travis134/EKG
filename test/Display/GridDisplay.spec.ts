...
describe('GridDisplay', () => {
    ...
    it('should render large squares', () => {
        ...
        const largeSquareLines = mockRenderContext.drawLineLineStyleValues.filter(lineStyle => lineStyle.width === 2).length;
    ...
    it('should render small squares', () => {
        ...
        const smallSquareLines = mockRenderContext.drawLineLineStyleValues.filter(lineStyle => lineStyle.width === 1).length;
